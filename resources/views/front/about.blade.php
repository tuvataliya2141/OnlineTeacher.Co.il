...
<div class="container">
  <div class="row ">
    ...
    <div class="col-sm-8 col-md-8 col-lg-9 mtb_30">
      ...
      <div class="row">
        <div class="col-md-12">
          <figure> <img src="{{asset('public/images/about-page-gaando.jpg')}}" alt="#"> </figure>
        </div>
        <div class="col-md-12">
      ...
      <div class="team_grid box">
        <div class="team3col  owl-carousel">
          <div class="item team-detail">
            <div class="team-item-img"> <img src="{{asset('public/images/tm1.jpg')}}" alt="" /> </div>
          ...
          <div class="item team-detail">
            <div class="team-item-img"> <img src="{{asset('public/images/tm2.jpg')}}" alt="" /> </div>
            <div class="team-designation mt_20">php Developer</div>
            <h4 class="team-title  mtb_10">joseph Lui </h4>
            <p>Lorem ipsum dolor sit amet, sea in odio erat, volumu Clita prodesset Rem ipsum dolor s..</p>
            <ul class="social mt_20 mb_80">
          ...
          <div class="item team-detail">
            <div class="team-item-img"> <img src="{{asset('public/images/tm3.jpg')}}" alt="" /> </div>
            <div class="team-designation mt_20">php Developer</div>
            <h4 class="team-title  mtb_10">joseph Lui </h4>
            <p>Lorem ipsum dolor sit amet, sea in odio erat, volumu Clita prodesset Rem ipsum dolor s..</p>
            <ul class="social mt_20 mb_80">
          ...
          <div class="item team-detail">
            <div class="team-item-img"> <img src="{{asset('public/images/tm4.jpg')}}" alt="" /> </div>
            <div class="team-designation mt_20">php Developer</div>
            <h4 class="team-title  mtb_10">joseph Lui </h4>
            <p>Lorem ipsum dolor sit amet, sea in odio erat, volumu Clita prodesset Rem ipsum dolor s..</p>
            <ul class="social mt_20 mb_80">
          ...
          <div class="item team-detail">
            <div class="team-item-img"> <img src="{{asset('public/images/tm5.jpg')}}" alt="" /> </div>
            <div class="team-designation mt_20">php Developer</div>
            <h4 class="team-title  mtb_10">joseph Lui </h4>
            <p>Lorem ipsum dolor sit amet, sea in odio erat, volumu Clita prodesset Rem ipsum dolor s..</p>
            <ul class="social mt_20 mb_80">
